...
function troya_directions_default_routes(): array {
	return array(
		...
		array(
			...
			'text'  => 'Автобус 22 до остановки «Батурина» (Кремль). Либо до остановки «Площадь Восстания», далее автобус 29 или 47 до «Площади Габдуллы Тукая». Либо до остановки «Метро Яшлек», далее на метро до станции «Площадь Габдуллы Тукая».',
		),
	);
}
