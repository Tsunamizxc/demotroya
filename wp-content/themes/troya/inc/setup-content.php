...
function troya_seed_content(): void {
	...
	$defaults = array(
		...
		'seo_rooms_description'   => 'Каталог номеров отеля «Троя» в Казани: стандарт, бизнес-комфорт и семейные категории.',
		'smtp_host'               => 'smtp.beget.com',
		'smtp_port'               => 465,
		'smtp_encryption'         => 'ssl',
		'smtp_username'           => 'troya-hotel-tickets@troy-a-hotel.ru',
		'smtp_from_email'         => 'troya-hotel-tickets@troy-a-hotel.ru',
		'smtp_from_name'          => 'Отель Троя',
		'smtp_to_email'           => 'tech@cursiva.ru',
		...
		'home_gallery_title'      => "Атмосфера<br /><em>отеля Троя</em>",
		'home_gallery_text'       => 'Номера, ресепшен, столовая и виды здания — загляните в фотогалерею и почувствуйте настроение отеля ещё до заезда.',
		'home_gallery_cta'        => 'Смотреть все фото',
		...
		'modal_hint'              => '* ОБЯЗАТЕЛЬНЫЕ ПОЛЯ · ЗАВТРАК +300 ₽',
	);
	...
	$amenity_defs = array(
		...
		array( 'transfer.png', 'Трансфер по городу', 'Организация трансфера по городу для гостей отеля.' ),
